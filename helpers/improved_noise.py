  ...
  for x in range(min_x, max_x):
      for y in range(min_y, max_y):
          ...
          if random.random() < 0.5:
              ...
              triangle2.faces.append(Face([Vertex(Vector3(face_width + dx11, face_width + dy11, height11), obj_pos),
              ...
              triangle1.faces.append(Face([Vertex(Vector3(dx01, face_width + dx01, height01), obj_pos),
                                            ...
                                            Vertex(Vector3(face_width + dx11, face_width + dy11, height11), obj_pos)
                                            ], material))
